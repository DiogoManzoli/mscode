...
<body>
    ...
    <form action="msavalie.php" method="POST">
        ...
        <div class="container">
            <div class="mx-auto text-center" style="max-width:420px; min-width:150px;">
                <div class="mb-3">
    ...
    <H1 class="container text-center" id="Tcarrossel">VEJA O QUE NOSSOS CLIENTES FALAM DE NÓS:</H1>
